...
export const translations = {
  id: {
    ...
    dashboard: {
      ...
      searchPlaceholder: "Cari langganan, kategori, atau apa saja...",
      greetingSubtitle: "Yuk, cek rangkuman langgananmu hari ini!",
      seeAll: "Lihat semua",

      statTotalDeltaUp: "↑ {{value}} dari bulan lalu",
      statTotalDeltaDown: "↓ {{value}} dari bulan lalu",
      statTotalDeltaFlat: "Sama seperti bulan lalu",
      statUpcomingLabel: "Tagihan terdekat",
      statUpcomingValue: "{{count}} langganan",
      statUpcomingSub: "dalam 7 hari ke depan",
      statSavingsLabel: "Potensi penghematan",
      statSavingsSub: "dari trial yang mau berakhir",
      statSavingsSubEmpty: "Gak ada trial yang mau berakhir",
      statActiveLabel: "Total langganan aktif",
      statActiveSub: "{{count}} kategori",

      bannerTrialTitle: "Kamu punya {{count}} langganan trial yang mau berakhir",
      bannerTrialSub: "Bisa hemat {{amount}}/bulan kalau di-cancel tepat waktu!",
      bannerTrialCta: "Review Sekarang",
      bannerGroupTitle: "Mulai ajak teman patungan!",
      bannerGroupSub: "Hemat lebih banyak dengan group.",
      bannerGroupCta: "Buat Group",
      bannerUpgradeTitle: "Dapatkan lebih dengan Notifin Premium",
      bannerUpgradeSub: "Analisis mendalam, rekomendasi hemat, fitur eksklusif lainnya.",
      bannerUpgradeCta: "Upgrade Sekarang",

      billsCardTitle: "Tagihan Terdekat",
      billsEmptyShort: "Aman, gak ada tagihan dalam 7 hari ke depan.",

      categoryCardTitle: "Pengeluaran per Kategori",
      categoryPeriodLabel: "Bulan Ini",
      categoryTotalLabel: "Total",
      categoryEmpty: "Belum ada data kategori bulan ini.",

      recentCardTitle: "Langganan Terbaru",
      recentAddedToday: "Ditambahkan hari ini",
      recentAddedYesterday: "Ditambahkan kemarin",
      recentAddedDaysAgo: "Ditambahkan {{days}} hari lalu",
      recentEmpty: "Belum ada langganan yang ditambahkan.",

      recommendSectionTitle: "Rekomendasi untukmu",
      recommendSectionSub: "Promo & penawaran pilihan berdasarkan langgananmu.",
      recommendCta: "Lihat Penawaran",
      recommendLockedTitle: "Rekomendasi khusus Premium",

      sidebarPremiumTitle: "Kamu Premium 🎉",
      sidebarPremiumActiveUntil: "Aktif sampai {{date}}",
      sidebarPremiumCta: "Lihat Semua Fitur",
      shareCta: "Bagikan pengeluaran bulan ini",
    },
    groups: {
      title: "Grup",
    ...
    upgrade: {
      ...
      subtitle: "Sudah 5 langganan aktif di paket gratis. Buka semua fitur biar gak ada yang kelewat.",
      perMonth: "/bulan",
      perYear: "/tahun",
      yearlyPill: "Hemat 35%",
    ...
    landing: {
      ...
      heroTrust: "Gratis untuk hingga 5 langganan · Tanpa kartu kredit",
      heroMockupAlt: "Tampilan dashboard Notifin di laptop dan HP",
      trust1: "Tanpa kartu kredit buat mulai",
      trust2: "Data privat & aman",
      trust3: "Cancel kapan saja, gak ribet",

      painEyebrow: "MASALAHNYA APA SIH?",
      painTitle: "Langganan Digital Gampang Bikin Boncos Diam-Diam",
      painSubtitle: "Kalau kamu ngerasain salah satu dari ini, kamu gak sendirian — dan Notifin dibuat buat ngatasin semuanya.",
      pain1Title: "Kehilangan Hitungan",
      pain1Body: "Udah gak inget lagi ada berapa banyak langganan yang masih aktif.",
      pain2Title: "Lupa Jatuh Tempo",
      pain2Body: "Tau-tau kena tagihan, atau trial gratis diam-diam berubah jadi bayar.",
      pain3Title: "Pengeluaran Gak Kerasa",
      pain3Body: "Rp50rb sini, Rp30rb sana — pas dijumlah totalnya bikin kaget.",
      pain4Title: "Jarang Dipakai, Tetap Bayar",
      pain4Body: "Ada langganan yang udah lama gak disentuh, tapi tetap narik saldo tiap bulan.",
      pain5Title: "Bingung Mana yang Bisa Dihemat",
      pain5Body: "Gak ada cara gampang buat tahu langganan mana yang sebenarnya bisa dipangkas.",
      ...
      groupsEyebrow: "PATUNGAN BARENG",
      groupsTitle: "Langganan Lebih Hemat Kalau Dibagi Bareng",
      groupsSubtitle:
        "Ajak keluarga atau teman patungan Netflix, Spotify, atau langganan lain — bagi biaya secara adil, otomatis.",
      groupsPoint1Title: "Bikin atau Gabung Group",
      groupsPoint1Body: "Buat group baru atau gabung pakai kode undangan dari anggota lain.",
      groupsPoint2Title: "Bagi Biaya Otomatis",
      groupsPoint2Body: "Notifin ngitungin bagian tiap anggota, jadi gak perlu itung manual.",
      groupsPoint3Title: "Pantau Siapa Belum Bayar",
      groupsPoint3Body: "Lihat status pembayaran tiap anggota dan kirim pengingat kalau perlu.",
      groupsCta: "Buat Group Sekarang",
      groupsSampleName: "Keluarga Rumah",
      groupsSampleMeta: "4 anggota",
      ...
      how1Body: "Masukkan semua langganan yang kamu gunakan, dari streaming, software, sampai aplikasi kerja.",
      how2Title: "Atur Pengingat",
      how2Body: "Pilih tanggal jatuh tempo dan atur notifikasi sesuai kebutuhanmu.",
      how3Title: "Dapat Notifikasi",
      how3Body: "Terima pengingat otomatis sebelum jatuh tempo, lewat aplikasi, email, atau WhatsApp.",
      how4Title: "Temukan Peluang Hemat",
      how4Body: "Lihat analisis pengeluaran, temukan langganan yang tidak terpakai, dan dapatkan rekomendasi lebih hemat.",
      ...
      pricingFreeItem1: "Hingga 5 langganan aktif",
    ...
    pricingPage: {
      ...
      subtitle: "Mulai gratis buat sampai 5 langganan. Upgrade kapan saja kalau butuh lebih.",
      ...
      faq3Q: "Kenapa paket Gratis dibatasi 5 langganan?",
      faq3A:
        "Biar Notifin tetap bisa dipakai siapa saja tanpa bayar. Langganan yang sudah ada tetap aman kalau kamu turun dari Premium — kamu cuma nggak bisa nambah baru sampai di bawah 5 lagi.",
  ...
  en: {
    ...
    dashboard: {
      ...
      searchPlaceholder: "Search subscriptions, categories, anything...",
      greetingSubtitle: "Here's your subscription summary for today.",
      seeAll: "See all",

      statTotalDeltaUp: "↑ {{value}} from last month",
      statTotalDeltaDown: "↓ {{value}} from last month",
      statTotalDeltaFlat: "Same as last month",
      statUpcomingLabel: "Upcoming Bills",
      statUpcomingValue: "{{count}} subs",
      statUpcomingSub: "in the next 7 days",
      statSavingsLabel: "Potential Savings",
      statSavingsSub: "from trials ending soon",
      statSavingsSubEmpty: "No trials ending soon",
      statActiveLabel: "Active Subscriptions",
      statActiveSub: "{{count}} categories",

      bannerTrialTitle: "You have {{count}} trial subscriptions ending soon",
      bannerTrialSub: "Save {{amount}}/month if you cancel in time!",
      bannerTrialCta: "Review Now",
      bannerGroupTitle: "Start splitting bills with friends!",
      bannerGroupSub: "Save more by sharing with a group.",
      bannerGroupCta: "Create Group",
      bannerUpgradeTitle: "Get more with Notifin Premium",
      bannerUpgradeSub: "Deeper insights, savings recommendations, and exclusive features.",
      bannerUpgradeCta: "Upgrade Now",

      billsCardTitle: "Upcoming Bills",
      billsEmptyShort: "All clear — nothing due in the next 7 days.",

      categoryCardTitle: "Spending by Category",
      categoryPeriodLabel: "This Month",
      categoryTotalLabel: "Total",
      categoryEmpty: "No category data for this month yet.",

      recentCardTitle: "Recently Added",
      recentAddedToday: "Added today",
      recentAddedYesterday: "Added yesterday",
      recentAddedDaysAgo: "Added {{days}} days ago",
      recentEmpty: "No subscriptions added yet.",

      recommendSectionTitle: "Recommended for You",
      recommendSectionSub: "Curated promos and offers based on your subscriptions.",
      recommendCta: "View Offer",
      recommendLockedTitle: "Premium-only recommendations",

      sidebarPremiumTitle: "You're Premium 🎉",
      sidebarPremiumActiveUntil: "Active until {{date}}",
      sidebarPremiumCta: "View All Features",
      shareCta: "Share this month's spending",
    },
    groups: {
      title: "Groups",
    ...
    landing: {
      ...
      heroTrust: "Free for up to 5 subscriptions · No credit card needed",
      heroMockupAlt: "Notifin dashboard shown on laptop and phone",
      trust1: "No credit card to start",
      trust2: "Private & secure data",
      trust3: "Cancel anytime, no hassle",

      painEyebrow: "SOUND FAMILIAR?",
      painTitle: "Digital Subscriptions Quietly Drain Your Wallet",
      painSubtitle: "If any of this hits home, you're not alone — and it's exactly what Notifin fixes.",
      pain1Title: "Lost Count",
      pain1Body: "You've lost track of how many subscriptions are even still active.",
      pain2Title: "Missed Due Dates",
      pain2Body: "Suddenly charged, or a free trial quietly turns into a paid bill.",
      pain3Title: "Spending You Don't Feel",
      pain3Body: "A little here, a little there — the total adds up to a shock.",
      pain4Title: "Paying for What You Don't Use",
      pain4Body: "Some subscription you haven't touched in months is still charging you.",
      pain5Title: "No Idea What to Cut",
      pain5Body: "There's no easy way to tell which subscriptions are actually worth dropping.",
      ...
      groupsEyebrow: "SPLIT WITH GROUPS",
      groupsTitle: "Subscriptions Cost Less When You Split Them",
      groupsSubtitle:
        "Invite family or friends to split Netflix, Spotify, or any other subscription — costs divided fairly, automatically.",
      groupsPoint1Title: "Create or Join a Group",
      groupsPoint1Body: "Start a new group or join one using an invite code from another member.",
      groupsPoint2Title: "Automatic Cost Splitting",
      groupsPoint2Body: "Notifin works out everyone's share, so nobody has to do the math by hand.",
      groupsPoint3Title: "See Who Hasn't Paid",
      groupsPoint3Body: "Track each member's payment status and send a reminder when you need to.",
      groupsCta: "Create a Group Now",
      groupsSampleName: "Family Group",
      ...
      how1Body: "Log everything you're subscribed to — streaming, software, and work apps alike.",
      how2Title: "Set Up Reminders",
      how2Body: "Pick a due date and set up notifications the way you want them.",
      how3Title: "Get Notified",
      how3Body: "Receive automatic reminders before every due date — via app, email, or WhatsApp.",
      how4Title: "Find Savings Opportunities",
      how4Body: "See spending insights, spot subscriptions you're not using, and get recommendations to save more.",
      ...
      pricingFreeItem1: "Up to 5 active subscriptions",
    ...
    pricingPage: {
      ...
      subtitle: "Start free for up to 5 subscriptions. Upgrade anytime you need more.",
      ...
      faq3Q: "Why is the Free plan capped at 5 subscriptions?",
      faq3A:
        "So Notifin stays usable for everyone without paying. Existing subscriptions stay safe if you drop from Premium — you just can't add new ones until you're back under 5.",
